...
class viewport(body):
    def __init__(self, id: int, positionX: int, positionY: int, parentReference: object, curentCamera: camera, anchor: object, positionFromAnchorX: int, positionFromAnchorY: int, name: str, positionFromParentX=0, positionFromParentY=0):
        super().__init__(id, positionX, positionY, parentReference, positionFromParentX, positionFromParentY, name)
